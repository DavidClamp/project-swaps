...
- [TABLE OF CONTENTS](#table-of-contents)
  ...
  - [| static | style.css | ✅ PASS |  | All root variables and vendor prefixes validated successfully vendor prefixes. |](#-static--stylecss---pass----all-root-variables-and-vendor-prefixes-validated-successfully-vendor-prefixes-)
    - [Python Validation](#python-validation)
  - [2. Responsive Testing](#2-responsive-testing)
    - [Responsiveness](#responsiveness)
  - [3. Browser Compatibility](#3-browser-compatibility)
  - [4. Data Integrity \& Logic Testing](#4-data-integrity--logic-testing)
    - [4.1 Market Data Logic](#41-market-data-logic)
    - [Scenario A: The "6,000 Record" Load Test](#scenario-a-the-6000-record-load-test)
    - [Scenario B: Front-End Stability Test](#scenario-b-front-end-stability-test)
    - [Scenario C: Attribution Links](#scenario-c-attribution-links)
    - [4.2 Trade Capture Validation](#42-trade-capture-validation)
    - [4.3 Automated Profile Syncing](#43-automated-profile-syncing)
  - [5. Business Logic \& Data Privacy](#5-business-logic--data-privacy)
  - [| Portfolio Tagging | Outright Book ID | Added TRD-151 to two Outright trades.|Dashboard aggregates individual Outrights into a single portfolio row. |	✅ PASS |](#-portfolio-tagging--outright-book-id--added-trd-151-to-two-outright-tradesdashboard-aggregates-individual-outrights-into-a-single-portfolio-row--pass-)
    - [5.1 Tiered Access Validation](#51-tiered-access-validation)
  - [6. Defensive Programming](#6-defensive-programming)
  - [| Token Priority | Sign-In Flow | Success: Verified system prioritises 6-digit MFA token over static credentials for live session access. |	✅ PASS|](#-token-priority--sign-in-flow--success-verified-system-prioritises-6-digit-mfa-token-over-static-credentials-for-live-session-access--pass)
  - [Section 6.1  Stripe Subscription \& Webhook Integration](#section-61--stripe-subscription--webhook-integration)
  - [| Session Hijacking	| Attempt manual access to /success/ URL. |	View blocks access without a valid session\_id from Stripe. | Redirected to Dashboard with "Access Denied" warning.	| ✅ PASS |](#-session-hijacking-attempt-manual-access-to-success-url-view-blocks-access-without-a-valid-session_id-from-stripe--redirected-to-dashboard-with-access-denied-warning--pass-)
    - [Visual Evidence](#visual-evidence)
  - [: Dashboard showing the "PRO" badge and the Active Strategies table.](#-dashboard-showing-the-pro-badge-and-the-active-strategies-table)
    - [Stripe Screenshots](#stripe-screenshots)
  - [| \[Webhook 200 OK\] | Critical Security Proof. |	The Stripe Dashboard (Test Mode) \> Developers \> Webhooks, showing a list of 200 status codes.|](#-webhook-200-ok--critical-security-proof-the-stripe-dashboard-test-mode--developers--webhooks-showing-a-list-of-200-status-codes)
  - [7. Lighthouse Audit](#7-lighthouse-audit)
  - [| 500 |  |  |Tested using trap door URL|](#-500-----tested-using-trap-door-url)
  - [8. User Story Testing](#8-user-story-testing)
    - [Features Mapped to User Stories](#features-mapped-to-user-stories)
  - [9. Automated Testing](#9-automated-testing)
    - [9.1 Django Unittest Framework](#91-django-unittest-framework)
    - [**Running Tests**](#running-tests)
    - [9.2 Coverage Testing](#92-coverage-testing)
  - [10. Known Bugs, Issues \& Fixes](#10-known-bugs-issues--fixes)
    - [10.1 Fixed Bugs](#101-fixed-bugs)
    - [10.2 Unfixed Bugs](#102-unfixed-bugs)
